...
from tracer.colo_tracer_new import symbolic_trace, ColoTracer, bias_addition_pass
...
def test_linear_module():
    ...
    meta_args = {'x': torch.rand(3, 3).to('meta')}
    tracer = ColoTracer()
    # graph():
    ...
    gm.recompile()
    bias_addition_pass(gm, model, meta_args)
    print(gm.code)
    print("*"*30)
